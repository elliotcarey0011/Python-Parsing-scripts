...
dfe = pd.read_excel("facebook3.xls", sheet_name=10)
dff = pd.read_excel("facebook3.xls", sheet_name=19)
dfg = pd.read_excel("facebook3.xls", sheet_name=20)
dfh = pd.read_excel("facebook3.xls", sheet_name=22)
dfi = pd.read_excel("facebook3.xls", sheet_name=9)
df1 = dfa[['Permalink','Post ID','Lifetime Post Total Impressions','Lifetime Post Total Reach', 'Lifetime Total Video Views' , 'Lifetime Unique Video Views','Lifetime Total 30-Second Views','Lifetime Unique 30-Second Views','Lifetime Total watches at 95%','Lifetime Unique watches at 95%']]
...
df8.to_excel(writer,'Sheet1', startcol=62)
df9.to_excel(writer,'Sheet1', startcol=66)
writer.save()
